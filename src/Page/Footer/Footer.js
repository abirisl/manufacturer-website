...
const Footer = () => {
    return (
        <div>
            <footer class="footer p-10 bg-[#6E8882] text-white">
                <div>
            ...
            <footer class="footer px-10 py-4 border-t bg-[#6E8882] text-white border-base-300">
                <div class="items-center grid-flow-col">
                    ...
                    <p>MH Industries Ltd. <br/>Providing reliable tech since 1992</p>
                </div>
